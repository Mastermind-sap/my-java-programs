        ...
        do
        {
            ...
            if(s.equalsIgnoreCase("yes"))
            {
                ...
                {DateFormat df = new SimpleDateFormat("dd/MM/yy HH:mm:ss");
                    ...
                    int date=Integer.parseInt(ob.checkin_date_time[pos].substring(0,2));
                    ...
                    ob.name_r[ob.register_no]=ob.name[pos];
                    ...
                    int b=0;
                    do
                    { System.out.println("Do you want to print a bill?(yes/no)");
                        String bill=sc.next();
                        bill+=sc.nextLine();
